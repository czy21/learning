    ...
    public static void main(String[] args) throws Exception {
        ...
        stream.addSink(JdbcSink.sink(
                ...
                new JdbcConnectionOptions.JdbcConnectionOptionsBuilder()
                        .withUrl("jdbc:mysql://192.168.2.18:3306/erp_local?user=admin&password=Czy.190815&serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false&useUnicode=true&rewriteBatchStatements=true&useCursorFetch=true")
